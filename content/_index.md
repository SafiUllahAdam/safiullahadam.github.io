...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        My research interests sit at the intersection of **semi-supervised learning**, **graph representation learning**, **edge AI**, **distributed machine learning**, **natural language processing**, and **agentic AI**, with a growing interest in how **multiple models can learn collaboratively** under label scarcity.
